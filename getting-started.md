...
check that your guide is up-to-date!
 ...
 - Jenny Bryan's excellent Data wrangling course [STAT545](http://stat545.com/) (all materials and code openly available)

 - Ethan White's semester course [Data Carpentry Course for Biologists](http://www.datacarpentry.org/semester-biology/)

 - [RStudio cheatsheets](https://www.rstudio.com/resources/cheatsheets/) for anything & everything
...
### Books
 ...
 - The freely available [Modern Diver: An intro to statistical and data sciences in R](https://ismayc.github.io/moderndiver-book/) by Chester Ismay and Albert Y. Kim
 - A great and in depth book by Hadley Wickham & Garrett Grolemund: [R for Data Science](http://r4ds.had.co.nz/)
...
[Getting Started](#some-tips-on-getting-started)

[Web Resources](#web-resources)

[Books](#books)

[Mailing Lists](#other-mailing-lists-discussion-boards-and-resources)
